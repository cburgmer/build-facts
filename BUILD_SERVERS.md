...
See `java -jar build-facts-0.6.1-standalone.jar concourse --help` for more
options.
...
See `java -jar build-facts-0.6.1-standalone.jar gocd --help` for more options.
...
See `java -jar build-facts-0.6.1-standalone.jar jenkins --help` for more
options.
...
See `java -jar build-facts-0.6.1-standalone.jar teamcity --help` for more
options.
