...
it from your Concourse instance's main page. To get started run
    ...
    $ java -jar build-facts-0.2.0-standalone.jar concourse build-facts

See `java -jar build-facts-0.2.0-standalone.jar concourse --help` for more
options.
...
[published as a JUnit XML report file](https://www.go.cd/documentation/user/current/configuration/dev_upload_test_report.html).
    ...
    $ GOCD_USER="..." GOCD_PASSWORD="..." \
          java -jar build-facts-0.2.0-standalone.jar gocd http://localhost:8153/go    # replace with your GoCD URL

See `java -jar build-facts-0.2.0-standalone.jar gocd --help` for more options.
...
[Parameterized Trigger Plugin](https://wiki.jenkins-ci.org/display/JENKINS/Parameterized+Trigger+Plugin).
    ...
    $ JENKINS_USER="..." JENKINS_PASSWORD="..." \
          java -jar build-facts-0.2.0-standalone.jar jenkins http://localhost:8080    # replace with your Jenkins URL

See `java -jar build-facts-0.2.0-standalone.jar jenkins --help` for more
options.
...
configured to pick up `*.xml` test artifacts generated by the test run.
    ...
    $ TEAMCITY_USER="..." TEAMCITY_PASSWORD="..." \
          java -jar build-facts-0.2.0-standalone.jar teamcity http://localhost:8111 -p PROJECT_NAME    # replace with your TeamCity URL and project name
...
See `java -jar build-facts-0.2.0-standalone.jar teamcity --help` for more
options.
